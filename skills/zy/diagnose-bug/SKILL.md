...
Build the right feedback loop, and the bug is 90% diagnosed.
...
Why bother: a minimal repro shrinks the hypothesis space in Phase 3 (fewer moving parts left to suspect).
